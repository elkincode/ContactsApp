...
class DataManager {
    ...
    var names = ["Lenita", "Naomi", "Stevie",
             "Tanja", "Quincy", "Felecia",
             "Teddy", "Cecil", "Denice", "Noe"
    ]
    
    var surnames = ["Zaldivar", "Bledsoe", "Lofthouse",
             "Verrett", "Hirschman", "Tuohy",
             "Whichard", "Hugley", "Degraw", "Mcglone"
    ]
    
    var emails = ["poweqpe@icloud.com", "wqepowpqwoe@icloud.com", "jsaldjaasd@icloud.com",
    ...
    var phones = ["+1 201-238-8917", "+1 201-245-3197", "+1 317-506-9997",
